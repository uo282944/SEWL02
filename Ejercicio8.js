...
class Meteorologia {
    ...
    verOviedo(){
        ...
        this.cargarDatos("http://api.openweathermap.org/data/2.5/weather?q=" + "Oviedo" + "," + this.codigoPais + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verBarcelona(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("http://api.openweathermap.org/data/2.5/weather?q=" + "Barcelona" + "," + this.codigoPais + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verSevilla(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("http://api.openweathermap.org/data/2.5/weather?q=" + "Sevilla" + "," + this.codigoPais + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verValencia(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("http://api.openweathermap.org/data/2.5/weather?q=" + "Valencia" + "," + this.codigoPais + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verMalaga(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("http://api.openweathermap.org/data/2.5/weather?q=" + "Malaga" + "," + this.codigoPais + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }
