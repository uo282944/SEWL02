...
class Meteorologia {
    ...
    verOviedo(){
        ...
        this.cargarDatos("https://api.openweathermap.org/data/2.5/weather?q=Oviedo" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verBarcelona(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("https://api.openweathermap.org/data/2.5/weather?q=Barcelona" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verSevilla(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("https://api.openweathermap.org/data/2.5/weather?q=Sevilla" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verValencia(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("https://api.openweathermap.org/data/2.5/weather?q=Valencia" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }

    verMalaga(){
        this.borrarContenido();
        this.crearElemento("section","","footer"); // Crea un elemento con DOM para los datos obtenidos con JSON
        this.cargarDatos("https://api.openweathermap.org/data/2.5/weather?q=Malaga" + this.tipo + this.unidades + this.idioma + "&APPID=" + this.apikey);
    }
